package com.rodion.springboot.kafka.consumer.config;

import com.rodion.springboot.kafka.config.data.KafkaConfigData;
import com.rodion.springboot.kafka.config.data.KafkaConsumerConfigData;
